odoo.define('odoo_dynamic_advance.odoo_dynamic', function (require) {
"use strict";
    ...
    View.include({
        ...
        render_fields_show: function () {
            ...
            if (this.fields_view.type == 'tree' && typeof(this.result) != 'undefined'){
                ...
                QWeb.add_template("/odoo_dynamic_advance/static/src/xml/my_control.xml");
...
//                events
    ...
    FormView.include({
        ...
        render_buttons: function($node) {
            ...
            this.$buttons.find('.o_form_buttons_view').css({'float': 'left'});
        },
